...
const cards = [
  {
    ...
    title: "bridges", 
    desc: "Before World War II, Wrocław had 303 bridges. Today there are 100 bridges and 33 gangways. Unique on a Polish and European scale, the number of crossings is due to the location of the city. Wrocław is crossed by the rivers of Oder, Ślęza, Widawa, Bystrzyca, Dobra and a dozen or so streams. Depending on the water level there are up to 25 islands in the city boundaries.",
  },
  {
    src: "img/culture/oldtown_icon.png",
    title: "monuments", 
    desc: "Wrocław has two objects on the list of Monuments of History - the most valuable distinction awarded in the country to objects considered particularly valuable for culture, under the patronage of the President of the Republic of Poland. They are: the Historic Center Complex and Centennial Hall. The city has many viewpoints located on monuments, for example the northern tower of the Cathedral of St. John the Baptist.",
  },
  {
    src: "img/culture/dwarf_icon.png",
    title: "dwarfs", 
    desc: "Wrocław’s dwarfs are small figurines that first appeared in the city streets in 2005. Since then, their numbers have been continually growing, and today they are considered a tourist attraction: those who would like to combine sight-seeing in Wrocław with \"Hunting for dwarfs\" are offered special brochures with a map and mobile application. As of 2015, there are over 350 dwarfs spread all over the city.",
  },
]

const Architecture = () => (
  <Common.Section>
    <Common.BackgroundImg gradient src="img/culture/bridge.jpg">
