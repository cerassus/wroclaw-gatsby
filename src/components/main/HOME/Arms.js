...
const Arms = () => (
  <Common.Section cell>
    <Common.Flex reverse>
      <SVG row="30"  src="img/home/wroclaw_logo.svg" alt="wroclaw logo" />
      <Common.Content row="70" blue>
        <Common.Content centered>
          ...
          <p>
            ...
            established, which was to develop a new coat of arms for the city.
            The new city symbol was established by the new City Council in June
            1990. At first St. John the Baptist was straight (en face). In 1995
            this emblem was changed, and now we have a profile of the saint's
            head (some say this is the so called Tartar's head).{" "}
          </p>
          <p>
