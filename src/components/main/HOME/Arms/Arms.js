    ...
    <Common.Content row={70} blue >
      <Common.Content centered>
        ...
        <p>
          ...
          new city symbol was established by the new City Council in June 1990.
          At first St. John the Baptist was straight (en face). In 1995 this
          emblem was changed, and now we have a profile of the saint's head
          (some say this is the so called Tartar's head).{" "}
        </p>
        <p>
        ...
        <p>
          ...
          directed straight, with a youthful face with feminine-like curls, with
          a gloriole around his head, set on a reversed crown. A white head with
          black outline, a yellow gloriole and crown with black outline, red
          background
        </p>
      </Common.Content>
    </Common.Content>
    <SVG row={30} src="img/home/wroclaw_logo.svg" alt="wroclaw logo"></SVG>
  </Common.Section>
)
