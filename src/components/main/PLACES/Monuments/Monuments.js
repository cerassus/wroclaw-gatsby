...
const Monuments = () => (
    <SC.Container>
      <SC.Title>culture</SC.Title>
      <SC.Content>
        <SC.WrapElement></SC.WrapElement>
        <SC.WrapElement>
          <SC.TextTitle>old town</SC.TextTitle>
          <SC.Text>
        ...
        <SC.WrapElement>
          <SC.TextTitle>national museum</SC.TextTitle>
          <SC.Text>
        ...
        <SC.WrapElement></SC.WrapElement>
        <SC.WrapElement>
          <SC.TextTitle>hydropolis</SC.TextTitle>
          <SC.Text>
            Hydropolis is a science centre dedicated to water. Its exhibitions
            use a variety of technology to teach visitors about the role of
            water in the environment, its importance to humans, and the history
            of human interactions with water. The centre is located in a 4600 m²
            historic neo-Gothic underground reservoir, which had been used for
            drinking water from the time of its construction in the 1890s.
            According to its website, "Hydropolis is a place where diverse
            multimedia technologies, interactive installations, faithful
            replicas and models, as well as touch screens providing extensive
            information, serve one purpose - to show water from various
